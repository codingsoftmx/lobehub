...
# -*- coding: utf-8 -*-
"""
Complete Memory System - Database Initialization (ASCII Safe)
完整记忆系统 - 数据库初始化脚本（ASCII安全版本）
"""
...
def init_database(db_path: str = "memory/database/xiaozhi_memory.db") -> bool:
    ...
    try:
        ...
        print(f"  Total {len(tables_created)} tables")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("\n[X] Database initialization failed!")
        sys.exit(1)
