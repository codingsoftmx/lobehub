# @codingsoft/agentes-cli

Agentes command-line interface.
...
By default the CLI connects to `https://agentes.codingsoft.org`. To point it at a different server (e.g. a local instance):
