# 🤯 Agentes Desktop Application

Agentes Desktop is a cross-platform desktop application for [Agentes](https://agentes.codingsoft.org), built with Electron, providing a more native desktop experience and functionality.
...
- **🔗 Remote Server Sync**: Secure data synchronization with remote Agentes instances
...
1. Fork the [repository](https://github.com/codingsoftmx/lobehub)
...
- **Issues & Support**: [GitHub Issues](https://github.com/codingsoftmx/lobehub/issues)
