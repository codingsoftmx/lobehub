...
const getProtocolScheme = () => {
  if (isCanary) return 'agentes-canary';
  if (isNightly) return 'agentes-nightly';
  return 'agentes';
};
...
const config = {
  ...
  appId: 'org.codingsoft.agentes-desktop',
  appImage: {
  ...
  mac: {
    ...
    extendInfo: {
      ...
      CFBundleURLTypes: [
        {
          CFBundleURLName: 'Agentes Protocol',
