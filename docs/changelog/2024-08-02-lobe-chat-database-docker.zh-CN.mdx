---
title: Agentes Database Docker 镜像正式发布
description: Agentes v1.8.0 推出官方数据库 Docker 镜像，补齐服务端部署链路，支持云端数据同步、用户管理，并提供完整的自部署文档。
tags:
  - Agentes
  - Docker 镜像
  - 云端部署
...
# Agentes Database Docker 镜像：云端部署的最后一块拼图
