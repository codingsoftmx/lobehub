---
title: 在 Agentes 中配置 ZITADEL 身份验证服务
description: 学习如何在 Agentes 中配置 ZITADEL 身份验证服务，包括创建应用、配置环境变量等步骤。
tags:
  - ZITADEL
  - 身份验证服务
  - 环境变量配置
...
<Steps>
  ...
  <Image alt="创建 ZITADEL 应用 1" inStep src="/blog/assets8692892/3564110d-bef9-47f3-b775-e5f28b4275b2.webp" />

  填写应用名称，应用类型选择「Web」，点击「继续」。

  <Image alt="创建 ZITADEL 应用 2" inStep src="/blog/assets8692892/12451b47-8dcd-40a9-b18d-2806b07efecc.webp" />

  选择「Code」作为身份验证方式。

  <Image alt="创建 ZITADEL 应用 3" inStep src="/blog/assets8692892/9d5cb651-ad10-47c7-8c8b-2256163c5521.webp" />
  ...
  <Image alt="创建 ZITADEL 应用 4" inStep src="/blog/assets8692892/1699bf46-0c8d-4238-9eb5-34282bfe529a.webp" />
  ...
  <Image alt="创建 ZITADEL 应用 5" inStep src="/blog/assets8692892/375b3d73-6796-465c-9063-f2762093f763.webp" />

  记录下「ClientId」和「ClientSecret」备用。

  <Image alt="创建 ZITADEL 应用 6" inStep src="/blog/assets8692892/40bb6b4c-18e0-4ae5-abae-ae0cf202cf08.webp" />

  在应用设置页面中，切换到「令牌设置」选项卡，勾选「在 ID Token 中包含用户信息」选项，点击「保存」。

  <Image alt="创建 ZITADEL 应用 7" inStep src="/blog/assets8692892/20a257b5-d086-46f3-b5c2-f76394b11f55.webp" />

  切换到「URLs」选项卡，记录下「issuer」URL。

  <Image alt="创建 ZITADEL 应用 8" inStep src="/blog/assets8692892/79c55d44-8dcb-429c-a072-d3eb014bbceb.webp" />
...
<Callout>部署成功后，用户将能够通过 ZITADEL 中配置的用户进行身份验证并使用 LobeHub。</Callout>
