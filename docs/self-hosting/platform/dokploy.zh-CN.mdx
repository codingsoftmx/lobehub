---
title: 在 Dokploy 上部署 Agentes
description: 本文详细介绍如何在 Dokploy 中部署 Agentes，包括数据库配置、身份验证服务配置的设置步骤。
tags:
  - 服务端数据库
  - Postgres
  - Better Auth
...
![将 GitHub 绑定到 Dokploy](/blog/assets0f97d1dfccd5ba07172aff71ff9acd7b.webp)

2. 进入 Projects 界面创建一个 Project

![在 Dokploy 中创建项目](/blog/assetsb26b68a4875a6510ddc202dd4b40d010.webp)
...
![在 Dokploy 中创建 PostgreSQL 数据库](/blog/assets7006b60baaf62aa0d95cd40456e24afe.webp)
...
![在 Dokploy 中部署数据库](/blog/assets1b9283f9cc5fc5073ff9cffc24880e96.webp)
...
![在 Dokploy 中配置环境变量](/blog/assets6b67dabe7b9226cdff1bace5a3b8ab18.webp)
...
![部署 LobeHub 并查看进度](/blog/assets7c3eab218c0823fa353b1cd23afe21c3.webp)
...
![LobeHub 登录成功](/blog/assets11a8089b511aaa61e8982dea0a3665c5.webp)
