...
<Tabs>
  <Tab title="OpenAI Voices">
    Premium neural voices with natural prosody and intonation:
  ...
  <Tab title="Microsoft Edge Speech">
    Azure Neural Voices — an extensive library with 100+ voices across languages, regional accents (US, UK, AU, and more), and male/female options.
...
<Tabs>
  ...
  <Tab title="Language Learning">
    Practice speaking in a target language and hear correct pronunciation via TTS. The AI can provide feedback on phrasing and suggest improvements.
  </Tab>

  <Tab title="Multitasking">
    Get AI assistance while cooking, commuting, or exercising. Hands-free mode lets you interact without looking at a screen.
  </Tab>
