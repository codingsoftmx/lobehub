---
title: 在 Agentes 中使用 Black Forest Labs API Key
description: 学习如何在 Agentes 中配置和使用 Black Forest Labs API Key，使用先进模型进行高质量 AI 图像生成。
tags:
  - Black Forest Labs
  - 图像生成
  - API Key
...
# 在 Agentes 中使用 Black Forest Labs
