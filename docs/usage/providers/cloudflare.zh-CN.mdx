---
title: 在 Agentes 中使用 Cloudflare Workers AI
description: 学习如何在 Agentes 中配置和使用 Cloudflare Workers AI 的 API Key，以便开始对话和交互。
tags:
  - Agentes
  - Cloudflare
  - Workers AI
...
# 在 Agentes 中使用 Cloudflare Workers AI
