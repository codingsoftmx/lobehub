---
title: 在 Agentes 中使用 ComfyUI 生成图像
description: 学习如何在 Agentes 中配置和使用 ComfyUI 服务，支持 FLUX 系列模型的高质量图像生成和编辑功能
tags:
  - ComfyUI
  - FLUX
  - 文生图
...
<Image alt={'ComfyUI 设置界面'} inStep src={'/blog/assets17870709/3f31bc33-509f-4ad2-ba81-280c2a6ec5fa.webp'} />
