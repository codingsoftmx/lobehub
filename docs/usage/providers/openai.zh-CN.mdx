---
title: 在 Agentes 中使用 OpenAI API Key
description: 学习如何在 Agentes 中配置和使用 OpenAI API Key，支持 GPT-4o / GPT-4-turbo / GPT-4-vision
tags:
  - ChatGPT
  - GPT-4
  - GPT-4o
...
'https://github-production-user-asset-6210df.s3.amazonaws.com/28616219/296255167-f2745f2b-f083-4ba8-bc78-9b558e0002de.png'
  ...
  <Image alt={'填入 API 密钥'} inStep src={'/blog/assets17870709/3f31bc33-509f-4ad2-ba81-280c2a6ec5fa.webp'} />

  - 填入获得的 API 密钥
  - 为你的 AI 助手选择一个 OpenAI 的模型即可开始对话

  <Image alt={'选择 OpenAI 模型并开始对话'} inStep src={'/blog/assets17870709/ff7ebacf-27f0-42d7-810b-00314499a084.webp'} />
