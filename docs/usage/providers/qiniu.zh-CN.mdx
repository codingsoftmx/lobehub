---
title: 在 Agentes 中使用七牛云大模型 API Key
description: 学习如何在 Agentes 中配置和使用七牛云的大模型，提供强大的自然语言理解和生成能力。
tags:
  - API key
  - Web UI
  - 七牛
...
<Image alt={'在 LobeHub 中使用七牛云大模型'} cover src={'/blog/assets48b5c19e20fb870c7bdd34bd3aefbb21.webp'} />
