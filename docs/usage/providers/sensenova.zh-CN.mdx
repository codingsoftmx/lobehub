---
title: 在 Agentes 中使用商汤日日新
description: 学习如何在 Agentes 中配置和使用商汤日日新的 API Key，以便开始对话和交互。
tags:
  - Agentes
  - 商汤日日新
  - API密钥
...
<Steps>
  ...
  <Image alt={'开通日日新大模型'} inStep src={'/blog/assetsfae60ba54155478a1c363f0065ce76a6.webp'} />

  - 进入 [AccessKey 访问密钥](https://console.sensecore.cn/iam/Security/access-key) 页面
  - 创建一个访问密钥
  - 在弹出窗口中保存访问密钥 ID 和令牌

  <Image alt={'保存访问密钥'} inStep src={'/blog/assetse5dff9a2e16a134d85e891e4eb98fe55.webp'} />
  ...
  <Image alt={'填入访问密钥'} inStep src={'/blog/assets2a74d926ae05faf2ee9f8da858bec3f6.webp'} />

  - 填入获得的 `AccessKey ID` 和 `AccessKey Secret`
  - 为你的 AI 助手选择一个商汤日日新的模型即可开始对话

  <Image alt={'选择商汤日日新模型并开始对话'} inStep src={'/blog/assets52c8de6425a785409464561c09f8c98d.webp'} />
